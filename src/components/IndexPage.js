  ...
  render() {
    return (
      <div className="home">
        ...
        {"Welcome to my site! Please take a look around. If you want to contact me, use click the links below. If you're curious about how I made the site, check out "}
